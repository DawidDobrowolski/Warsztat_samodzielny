...
public class OrderDao {
    ...
    private static final String CREATE_ORDER_QUERY =
            "INSERT INTO order(entranceDate, planStartDate, startDate, employeeId, problemDescription, repairDescription, statusId, vehicleId, repairCost, partsCost, hoursNumber) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    private static final String READ_ORDER_QUERY =
            "SELECT * FROM order where id = ?";
    private static final String UPDATE_ORDER_QUERY =
            "UPDATE order SET entranceDate=?, planStartDate=?, startDate=?, employeeId=?, problemDescription=?, repairDescription=?, statusId=?, vehicleId=?, repairCost=?, partsCost=?, hoursNumber=? where id = ?";
